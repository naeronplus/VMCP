...
> = {
  QUEUED: ['DISPATCHING', 'BLOCKED', 'CANCELLED', 'LOCK_STALE'],
  DISPATCHING: ['STAGING', 'DISPATCH_TIMEOUT', 'BLOCKED', 'CANCELLED', 'LOCK_STALE'],
  DISPATCH_TIMEOUT: ['QUEUED', 'DEAD_LETTER', 'CANCELLED', 'LOCK_STALE'],
  ...
  ROLLBACK: [],
  COMPLETED: [],
  LOCK_STALE: ['QUEUED', 'DEAD_LETTER', 'CANCELLED'],
  DEP_FAILED: [],
